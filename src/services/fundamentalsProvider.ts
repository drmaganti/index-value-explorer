...
const FINNHUB_REQUEST_BATCH_SIZE = 8;
// Brief inter-batch pause (~250ms) lets the free-tier per-second budget
// recover without bumping the total run time over the Worker timeout.
const FINNHUB_BATCH_DELAY_MS = 250;
