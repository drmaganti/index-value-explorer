...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Analyzes stock indexes like QQQ, SPY, DIA, NIFTY, SENSEX to find value stocks." },
      { property: "og:description", content: "Analyzes stock indexes like QQQ, SPY, DIA, NIFTY, SENSEX to find value stocks." },
      { name: "twitter:description", content: "Analyzes stock indexes like QQQ, SPY, DIA, NIFTY, SENSEX to find value stocks." },
